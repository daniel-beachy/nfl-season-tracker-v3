...
The **Capture and publish** workflow runs every Tuesday at **14:00 UTC** (10 a.m. EDT / 9 a.m. EST), plus the **1st of every month January through September** at the same UTC time. The collector gates weekly runs to the regular season/playoffs, the final Tuesday before kickoff, and the first Tuesday after the Super Bowl. Other preseason Tuesdays are skipped. If the two schedules coincide, the daily snapshot key prevents duplication.

**Data is captured Tuesday mornings after the week's games.** Each numbered checkpoint describes the completed week. The collector verifies ESPN event completion and verifies that the next week's games have not begun, including Wednesday openers and Thanksgiving-eve games. Delayed runs or manual midweek captures are skipped rather than saving mixed-week odds/statistics; a collection that crosses the next kickoff fails explicitly. The Pro Bowl is not a competitive NFL checkpoint. GitHub Actions cron is best-effort, not a guaranteed execution time.
